...
def Config_instr(instr):
    ...
    instr.write("CH1:POSITION 0.0E+00"+EOL)         ##Places CH2 at 0 divisons about the display center line
    instr.write("CH2:POSITION 2.0E+00"+EOL)         ##Places CH2 at 2 divisons about the display center line
